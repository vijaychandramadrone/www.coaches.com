...
<ul class="bulleted-arrowed">
  ...
  <li><a href="<?php echo url_for('event/registration'); ?>">New Registration</a></li>


  <ul>
    <li>Assisting</li>
    <li>Lab Series/Telecalls</li>
    <ul>
      <li>Corporate Teleseries Calls</li>
      <ul>
        <li>Fundamentals</li>
        <li>Fulfillment</li>
        <li>Balance</li>
      ...
      <li>Co-Active Entrepreneur Calls</li> 
      <ul>
        <li>Discover the “X” Factor: Building a Six Figure Coaching Practice</li>
        <li>Why You Can't Sell Coaching  </li>
        <li>Enroll New Clients Without Fear </li>
        <li>What is Your Coaching Really Worth?</li>
      </ul> 
    </ul>
  </ul>
  
  <!-- <li><a href="http://www.thecoaches.com/coach-training/be-an-assistant/index-portal.html">New Assisting Registration</a></li> -->
<p>&nbsp;</p>
