...
/**
 * Base class that represents a row from the 'waitlist' table.
 *
 * 
 *
 ...
 */
abstract class BaseWaitlist extends BaseObject  implements Persistent {


  const PEER = 'WaitlistPeer';
	...
	/**
	 * Initializes internal state of BaseWaitlist object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Waitlist The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = WaitlistPeer::ID;
		}
	...
	public function setStudentId($v)
	{
		...
		if ($this->student_id !== $v) {
			$this->student_id = $v;
			$this->modifiedColumns[] = WaitlistPeer::STUDENT_ID;
		}
	...
	public function setEventId($v)
	{
		...
		if ($this->event_id !== $v) {
			$this->event_id = $v;
			$this->modifiedColumns[] = WaitlistPeer::EVENT_ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = WaitlistPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = WaitlistPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = WaitlistPeer::NUM_COLUMNS - WaitlistPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Waitlist object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = WaitlistPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseWaitlist:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			WaitlistPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseWaitlist:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseWaitlist:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(WaitlistPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
    }

    if ($this->isModified() && !$this->isColumnModified(WaitlistPeer::UPDATED_AT))
    {
      $this->setUpdatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseWaitlist:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			WaitlistPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = WaitlistPeer::doInsert($this, $con);
					...
					$affectedRows += WaitlistPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = WaitlistPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = WaitlistPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = WaitlistPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(WaitlistPeer::ID)) $criteria->add(WaitlistPeer::ID, $this->id);
		if ($this->isColumnModified(WaitlistPeer::STUDENT_ID)) $criteria->add(WaitlistPeer::STUDENT_ID, $this->student_id);
		if ($this->isColumnModified(WaitlistPeer::EVENT_ID)) $criteria->add(WaitlistPeer::EVENT_ID, $this->event_id);
		if ($this->isColumnModified(WaitlistPeer::CREATED_AT)) $criteria->add(WaitlistPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(WaitlistPeer::UPDATED_AT)) $criteria->add(WaitlistPeer::UPDATED_AT, $this->updated_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(WaitlistPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Waitlist (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Waitlist Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getStudent(PropelPDO $con = null)
	{
		if ($this->aStudent === null && ($this->student_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aStudent->addWaitlists($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseWaitlist:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseWaitlist::%s', $method));
    }
